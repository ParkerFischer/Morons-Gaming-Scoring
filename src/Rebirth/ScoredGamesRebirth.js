    ...
    <>
      ...
      <div className="d-flex justify-content-around flex-wrap mb-4">
        <div className=" col-md-2 scorebox text-light text-center align-text-center mx-4 my-2">
          ...
          <p className="mb-1">
            {`Kills: ${getTotal("player1Kills", topFourGames)}`}{" "}
          </p>
        ...
        <div className=" col-md-2 scorebox text-light text-center align-text-center mx-4 my-2">
          ...
          <p className="mb-1">
            {`Kills: ${getTotal("player2Kills", topFourGames)}`}{" "}
          </p>
          <p className="mb-1">% of points in scored games</p>
          <p className="mb-1">{`${(
        ...
        <div className=" col-md-2 scorebox text-light text-center align-text-center mx-4 my-2">
          ...
          <p className="mb-1">
            {`Kills: ${getTotal("player3Kills", topFourGames)}`}{" "}
          </p>
          <p className="mb-1">% of points in scored games</p>
          <p className="mb-1">{`${(
        ...
        <div className=" col-md-2 scorebox text-light text-center align-text-center mx-4 my-2">
          ...
          <p className="mb-1">
            {`Kills: ${getTotal("player4Kills", topFourGames)}`}{" "}
          </p>
          <p className="mb-1">% of points in scored games</p>
          <p className="mb-1">{`${(
